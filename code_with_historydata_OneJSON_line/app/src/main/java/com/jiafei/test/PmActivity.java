    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BtnDataSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PmActivity.this, MainActivity.class);//返回按钮定义
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    //接受温度
                    // 新的URL和参数
                    String url = "https://iot-api.heclouds.com/thingmodel/query-device-property-history?product_id=0w6evrQh6e&device_name=Arduino&identifier=PM&start_time="+time1+"&end_time="+time2 ;
...
// 获取当天0点的时间戳
    ...
    private void getStartDate() {          //下面是根据日期选择反馈的日期重新把日期提供给GET请求，重新获取数据并刷新显示
        Calendar calendar=Calendar.getInstance();
        datePickerDialog_start=new NewDatePickerDialog(PmActivity.this,
                    ...
                    if ((i2+1)<=10){
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                // 新的URL和参数
                                String url = "https://iot-api.heclouds.com/thingmodel/query-device-property-history?product_id=0w6evrQh6e&device_name=Arduino&identifier=PM&start_time="+selectedDate+"&end_time="+selectedDate2 ;
...
//                    resultList.add(formattedTime + "              " + "数据" + value);
                    ...
                    RTCurvesView.push2CurvePm(curve1, data2);
