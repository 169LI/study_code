...
public class Token {
    ...
    public static String token() throws UnsupportedEncodingException, NoSuchAlgorithmException, InvalidKeyException {
        ...
        String resourceName = "userid/382066";//这里写你的用户id
        String expirationTime = System.currentTimeMillis() / 1000 + 100 * 24 * 60 * 60 + "";
        String signatureMethod = SignatureMethod.SHA1.name().toLowerCase();
        //这个也是换成自己的Accesskey
        String accessKey = "Exv0LeSo1NaXMxcr6/8FvbkQ1aGbKQ6cK/w+jm9nCqpOsq1iVyueWMdRPlbXJg5J6l7dfbBlGjKRN9sdzrSNwg==";//这里放你的AccessKey（在Onenet官网的账户信息里面）
