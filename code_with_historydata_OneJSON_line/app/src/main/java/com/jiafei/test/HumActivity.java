...
public class HumActivity extends AppCompatActivity {
    ...
    private final String[] mDisplayMonths = {"1","2","3","4","5","6","7","8","9"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RTCurvesView.setCoordinator("时间", "数据",12,15,"int","int");
        ...
        BtnDataSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HumActivity.this, MainActivity.class);//返回按钮定义
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    //接受温度
                    // 新的URL和参数
                    String url = "https://iot-api.heclouds.com/thingmodel/query-device-property-history?product_id=0w6evrQh6e&device_name=Arduino&identifier=Hum&start_time="+time1+"&end_time="+time2+"&limit=12" ;
...
// 获取当天0点的时间戳
    ...
    private void getStartDate() {          //下面是根据日期选择反馈的日期重新把日期提供给GET请求，重新获取数据并刷新显示
        Calendar calendar=Calendar.getInstance();
        datePickerDialog_start=new NewDatePickerDialog(HumActivity.this,
                    ...
                    if ((i2+1)<=10){
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                // 新的URL和参数
                                String url = "https://iot-api.heclouds.com/thingmodel/query-device-property-history?product_id=0w6evrQh6e&device_name=Arduino&identifier=Hum&start_time="+selectedDate+"&end_time="+selectedDate2+"&limit=12" ;
...
//                    resultList.add(formattedTime + "              " + "数据" + value);
                    ...
                    RTCurvesView.push2CurveHum(curve1, data2);
                    RTCurvesView.gridOn(true);
                    RTCurvesView.setXDivNum(12);
