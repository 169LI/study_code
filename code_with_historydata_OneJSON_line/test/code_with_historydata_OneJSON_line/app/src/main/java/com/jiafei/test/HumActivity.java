        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    //接受温度
                    // 新的URL和参数
                    String url = "https://iot-api.heclouds.com/thingmodel/query-device-property-history?product_id=0w6evrQh6e&device_name=Arduino&identifier=Hum&start_time="+time1+"&end_time="+time2 ;
                    ...
                    if ((i2+1)<=10){
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                // 新的URL和参数
                                String url = "https://iot-api.heclouds.com/thingmodel/query-device-property-history?product_id=0w6evrQh6e&device_name=Arduino&identifier=Hum&start_time="+selectedDate+"&end_time="+selectedDate2 ;
