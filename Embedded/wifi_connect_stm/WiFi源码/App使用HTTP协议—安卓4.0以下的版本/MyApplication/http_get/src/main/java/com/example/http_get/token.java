...
public class token {
    ...
    public  String  key() throws UnsupportedEncodingException, NoSuchAlgorithmException, InvalidKeyException {
        ...
        String resourceName = "userid/360841";//"userid/12321";
        String expirationTime = 1956499200+"";
        String signatureMethod = SignatureMethod.SHA1.name().toLowerCase();
        String accessKey = "DZEo7CYQ2mhdK6RYG9gj5322rRBtXDyWsCvyQwIj4LrMuC13RSwDbA/IwhEjJH0kB3jfqtVp0hRMHVPpedMleg==";
